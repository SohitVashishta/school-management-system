    ...
    <div>
      ...
      <CRow className="justify-content-center py-4">
        <CCol md={12}>
          <CCard>
            <CCardHeader>
              <h5>{editingIndex >= 0 ? 'Edit Fees Record' : 'Add Fees Record'}</h5>
            </CCardHeader>
            <CCardBody>
              <CForm onSubmit={handleSubmit}>
                ...
                <CRow className="mt-3">
                  <CCol md={6}>
                    <CFormLabel htmlFor="feeDate">Fees Date</CFormLabel>
                    <CFormInput
                      type="date"
                      id="feesDate"
                      name="feesDate"
                ...
                <CTableBody>
                  {feesData.map((fee, index) => (
                    <CTableRow key={index}>
                      ...
                      <CTableDataCell>{fees.studentName}</CTableDataCell>
                      <CTableDataCell>{fees.feeAmount}</CTableDataCell>
                      <CTableDataCell>{fees.feeDate}</CTableDataCell>
                      <CTableDataCell>{fees.status}</CTableDataCell>
                      <CTableDataCell>
                        <CButton
                          color="warning"
                          size="sm"
